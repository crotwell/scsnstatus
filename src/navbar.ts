...
<nav class="sidebar">
  <ul>
    ...
    <li><a href="${import.meta.env.BASE_URL}realtime/index.html">Realtime</a></li>
    ...
    <li><a href="${import.meta.env.BASE_URL}computerstat/index.html">Computer</a></li>
    <li><a href="${import.meta.env.BASE_URL}sohstreams/index.html">SOH Streams</a></li>
